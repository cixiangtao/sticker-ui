...
**[Explore the live preview and component docs](https://cixiangtao.github.io/sticker-ui/)**
...
```bash
npx shadcn@latest add https://cixiangtao.github.io/sticker-ui/r/button.json --dry-run
npx shadcn@latest add https://cixiangtao.github.io/sticker-ui/r/button.json
```

Browse the [component preview](https://cixiangtao.github.io/sticker-ui/)
...
[`/r/registry.json`](https://cixiangtao.github.io/sticker-ui/r/registry.json).
